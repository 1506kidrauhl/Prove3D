                    ...
                    <div class="row bg-white has-shadow">
                        ...
                        <div class="col-xl-3 col-sm-6" onclick="filtro(cpu)">
                            <div class="item d-flex align-items-center">
                                <div ><img src="img/dashboard/cpu.png"></div>
                        ...
                        <div class="col-xl-3 col-sm-6" onclick="filtro(disco)">
                            <div class="item d-flex align-items-center">
                                <div><img src="img/dashboard/disco.png"></div>
                        ...
                        <div class="col-xl-3 col-sm-6" onclick="filtro(gpu)">
                            <div class="item d-flex align-items-center">
                                <div><img src="img/dashboard/gpu.png"></div>
                        ...
                        <div class="col-xl-3 col-sm-6" onclick="filtro(memoria)">
                            ...
                            <div class="item d-flex align-items-center">
                                <div><img src="img/dashboard/memoria.png"></div>
                ...
                <div class="container-fluid">
                    <div class="row" >
                        ...
                        <div class="statistics col-lg-3 col-12" style="display: none;" id="cpu" onclick="tbDisplay()">
                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('red','Temperatura(°C)')">
                                <div class="icon bg-red"><i class="fa fa-tasks"></i></div>
                                <div class="text"><small>Temperatura</small></div>
                            </div>

                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('green','Voltagem(V)')">
                        ...
                        <div class="statistics col-lg-3 col-12" style="display: none;" id="memoria" onclick="tbDisplay()">
                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('red','Leitura')">
                                <div class="icon bg-red"><i class="fa fa-tasks"></i></div>
                                <div class="text"><small>Leitura</small></div>
                            </div>

                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('green','Gravação')">
                                <div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
                        ...
                        <div class="statistics col-lg-3 col-12" style="display: none;" id="disco" onclick="tbDisplay()">
                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('red','Utilização(%)')" >
                                <div class="icon bg-red"><i class="fa fa-tasks"></i></div>
                        ...
                        <div class="statistics col-lg-3 col-12" style="display: none;" id="gpu" onclick="tbDisplay()">
                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('red','Em uso(%)')">
                                <div class="icon bg-red"><i class="fa fa-tasks"></i></div>
                                <div class="text"><small>Em uso</small></div>
                            </div>

                            <div class="statistic d-flex align-items-center bg-white has-shadow" onclick="gerarGrafico('green','Cache(%)')">
                                <div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
